...
function Home() {
  return (
    <>
      <Nav />
      <div className="min-h-screen bg-[url('/images/pagehome.jpg')] bg-cover bg-center flex justify-center items-center">
        <div className='bg-black/80 backdrop-blur-md rounded-3xl w-auto h-96 flex flex-col justify-center items-center m-4'>
          <h1 className="text-2xl md:text-5xl font-extrabold mb-4 text-white">
